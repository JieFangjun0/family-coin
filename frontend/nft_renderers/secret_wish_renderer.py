...
def get_admin_mint_info():
    ...
    """
    return {
        "help_text": '对于“秘密”，请提供: {"description": "公开的描述", "content": "秘密内容", "destroy_in_days": 1.5 (天)}',
        "default_json": '''{
...
def render(st, nft, balance, api_call_func, create_signed_message_func, view_context="collection"):
    ...
    creator_name = data.get('creator_username', '未知')
    st.caption(f"ID: `{nft_id[:8]}` | 创建者: **{creator_name}**")
