  ...
  <div class="wallet-view">
    ...
    <div v-if="!isLoading && !errorMessage" class="wallet-content">
      <div class="stats-grid">
        ...
        <BalanceCard v-if="userDetails" label="邀请人" :value="userDetails.inviter_username || '---'" />
      </div>
          ...
          <table v-else class="history-table">
            ...
            <tbody>
              <tr v-for="tx in history" :key="tx.tx_id">
                ...
                <td>{{ tx.type === 'out' ? tx.to_display : tx.from_display }}</td>
...
.loading-state, .error-state, .empty-history {
  text-align: center;
  padding: 3rem;
  color: #718096;
}
